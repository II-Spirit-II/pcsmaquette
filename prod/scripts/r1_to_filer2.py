...
class IPFailover:
    ...
    def __init__(self, conf="/root/pcs/cmdb.yml", server="filer2_server",
        ...
        self.__info_docker_stack = {
            #'87.98.143.213/32': 'dawanorg/fr',
            #'178.33.45.149/32': 'dawanbe',
            #'XX.XX.XX.XX/32': 'jehannorg',
            #'91.121.60.104/32': 'dj_serverorg'
        }

        self.debug = debug

    def r1_to_filer2(self):
